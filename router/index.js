...
// //postman checking api
// router.get("/test", (req, res) => {
//   res.status(202).json({ message: "mongoDB connected" });
// });
...
// //RESET PASSWORD SEND MAIL TO GMAIL ACCOUNT
...
//     subject: "password reset requiest",
//     text: `you are receive the email`,
//   };
//   sender.sendMail(composemail, (error, info) => {
//     if (error) {
//       res.status(400).json({ message: "something went wrong, try again " });
...
// //RESET PASSWORD TO CHANGE NEW PASSWORD REQUIEST IN GMAIL ACCOUNT
